...
\affil[d]{Department of Mathematics and Statistics, Lancaster University, Lancaster, LA1 4YF, United Kingdom}
...
%\red{Above the vortex line density threshold, the perturbation of normal fluid energy generated by the reconnection is still present when the successive reconnection takes place: the energy does not decay to zero, but will increase in time. 
%Below this critical threshold, in some situations, even a background level of normal  fluid disturbances which remains small but is constantly injected by reconnections may become relevant. 
%In general, these finite amplitude normal fluid disturbances constantly injected by reconnections may become relevant for various superfluid helium systems. 
%One example are oscillatory flows, widely studied  in superfluid helium using vibrating wires and forks. At low frequency, perturbations which start at finite-amplitude rather than infinitesimal-amplitude level  have enough time to became of order one (hence visible and destabilizing) in the supercritical part of the cycle \cite{barenghi1989modulated}. A second example is pipe flow, again relevant to helium experiments, which is known to suffer from finite-amplitude instabilities \cite{peixinho2007finite}. This effect clearly needs further investigations.} 
...
\begin{thebibliography}{10}
	...
	\bibitem{YaoHussainAnnRev2022}
	J Yao, F Hussain, Vortex reconnection and turbulence cascade.
	\newblock {\em\protect\JournalTitle{Ann. Rev. Fluid Mech.}} \textbf{54}, 317 (2022).
	...
	\newblock {\em\protect\JournalTitle{Phys. Rev. Lett.}} \textbf{105}, 255002 (2010).
	
	\bibitem{nazarenko2003}
	S Nazarenko, R West, Analytical solution for nonlinear {Schr{\"o}dinger} vortex reconnection.
	\newblock {\em\protect\JournalTitle{J. Low Temp. Phys.}} \textbf{132}, 1 (2003).
	
	\bibitem{bewley2008}
	GP Bewley, MS Paoletti, KR Sreenivasan, DP Lathrop, Characterization of reconnecting vortices in superfluid helium.
	\newblock {\em\protect\JournalTitle{Proc. Nat. Acad. Sci. USA}} \textbf{105}, 13707 (2008).
	
	\bibitem{paoletti2010}
	MS Paoletti, ME Fisher, DP Lathrop, Reconnection dynamics for quantized vortices.
	\newblock {\em\protect\JournalTitle{Physica D}} \textbf{239}, 1367--1377 (2010).
	
	\bibitem{zuccherQuantumVortexReconnections2012a}
	S Zuccher, M Caliari, AW Baggaley, CF Barenghi, Quantum vortex reconnections.
	\newblock {\em\protect\JournalTitle{Phys. Fluids}} \textbf{24}, 125108 (2012).
	
	\bibitem{villoisUniversalNonuniversalAspects2017a}
	A Villois, D Proment, G Krstulovic, Universal and nonuniversal aspects of vortex reconnections in superfluids.
	\newblock {\em\protect\JournalTitle{Phys. Rev. Fluids}} \textbf{2}, 044701 (2017).
	
	\bibitem{galantucciCrossoverInteractionDriven2019a}
	...
	\newblock {\em\protect\JournalTitle{Proc. Nat. Acad. Sci. USA}} \textbf{116}, 12204 (2019).
	
	\bibitem{tylutki2021universal}
	M Tylutki, G Wlaz{\l}owski, Universal aspects of vortex reconnections across the bcs-bec crossover.
	\newblock {\em\protect\JournalTitle{Physical Review A}} \textbf{103}, L051302 (2021).
	
	\bibitem{yaoSeparationScalingViscous2020}
	J Yao, F Hussain, Separation scaling for viscous vortex reconnection.
	\newblock {\em\protect\JournalTitle{J. Fluid Mech.}} \textbf{900}, R4 (2020).
	
	\bibitem{villoisIrreversibleDynamicsVortex2020}
	A Villois, D Proment, G Krstulovic, Irreversible dynamics of vortex reconnections in quantum fluids.
	\newblock {\em\protect\JournalTitle{Phys. Rev. Lett.}} \textbf{125}, 164501 (2020).
	
	\bibitem{promentMatchingTheoryCharacterize2020}
	D Proment, G Krstulovic, Matching theory to characterize sound smission during vortex reconnection in quantum fluids.
	\newblock {\em\protect\JournalTitle{Phys. Rev. Fluids}} \textbf{5}, 104701 (2020).
	
	\bibitem{leadbeaterSoundEmissionDue2001b}
	M Leadbeater, T Winiecki, DC Samuels, CF Barenghi, CS Adams, Sound emission due to superfluid vortex reconnections.
	\newblock {\em\protect\JournalTitle{Phys. Rev. Lett.}} \textbf{86}, 1410--1413 (2001).
	
	\bibitem{vinen2001decay}
	...
	\newblock {\em\protect\JournalTitle{Physical Review B}} \textbf{64}, 134520 (2001).
	
	\bibitem{vinen2002quantum}
	W Vinen, J Niemela, Quantum turbulence.
	\newblock {\em\protect\JournalTitle{Journal of low temperature physics}} \textbf{128}, 167--231 (2002).
	
	\bibitem{stasiakCrossComponentEnergyTransfer2024}
	PZ Stasiak, AW Baggaley, G Krstulovic, CF Barenghi, L Galantucci, Cross-component energy transfer in superfluid helium-4.
	\newblock {\em\protect\JournalTitle{J. Low Temp. Phys.}} (2024).
	
	\bibitem{stasiak2025inverse}
	PZ Stasiak, et~al., Inverse energy transfer in three-dimensional quantum vortex flows.
	\newblock {\em\protect\JournalTitle{arXiv preprint arXiv:2503.04450}} (2025).
	
	\bibitem{paoletti2008velocity}
	...
	\newblock {\em\protect\JournalTitle{Physical review letters}} \textbf{101}, 154501 (2008).
	
	\bibitem{guo2014visualization}
	W Guo, M La~Mantia, DP Lathrop, SW Van~Sciver, Visualization of two-fluid flows of superfluid helium-4.
	\newblock {\em\protect\JournalTitle{Proceedings of the National Academy of Sciences}} \textbf{111}, 4653--4658 (2014).
	
	\bibitem{perettiDirectVisualizationQuantum2023}
	...
	\newblock {\em\protect\JournalTitle{Science Advances}} \textbf{9}, eadh2899 (2023).
	
	\bibitem{boue-etal-2013}
	L Bou\'{e}, D Khomenko, V L'vov, I Procaccia, Analytic solution of the approach of quantum vortices towards reconnection.
	\newblock {\em\protect\JournalTitle{Phys. Rev. Lett.}} \textbf{111}, 145302 (2013).
	
	\bibitem{rica-2019}
	R S, Self-similar vortex reconnection.
	\newblock {\em\protect\JournalTitle{C. R. M\'{e}c}} \textbf{347}, 365 (2019).
	
	\bibitem{allen2014}
	AJ Allen, et~al., Vortex reconnections in atomic condensates at finite temperature.
	\newblock {\em\protect\JournalTitle{Phys. Rev. A}} \textbf{90}, 013601 (2014).
	
	\bibitem{galantucci-krstulovic-etal-2023}
	L Galantucci, G Krstulovic, C Barenghi, Friction-enhanced lifetime of bundled quantum vortices.
	\newblock {\em\protect\JournalTitle{Phys. Rev. Fluids}} \textbf{8}, 014702 (2023).
	
	\bibitem{baggaleySensitivityVortexFilament2012a}
	AW Baggaley, The sensitivity of the vortex filament method to different reconnection models.
	\newblock {\em\protect\JournalTitle{J. Low Temp. Phys.}} \textbf{168}, 18 (2012).
	
	\bibitem{BSS2023}
	CF Barenghi, L Skrbek, KR Sreenivasan, {\em Quantum {{T}}urbulence}.
	\newblock (Cambridge University Press), (2023).
	
	\bibitem{barenghi2004}
	CF Barenghi, DC Samuels, Scaling laws of vortex reconnections.
	\newblock {\em\protect\JournalTitle{J. Low Temp. Phys.}} \textbf{136}, 281 (2004).
	
	\bibitem{schwarz1981}
	KW Schwarz, CW Smith, Pulsed-ion study of ultrasonically generated turbulence in superfluid {{4He}}.
	\newblock {\em\protect\JournalTitle{Physics Letters A}} \textbf{82}, 251--254 (1981).
	
	\bibitem{milliken1982}
	FP Milliken, KW Schwarz, CW Smith, Free {{Decay}} of {{Superfluid Turbulence}}.
	\newblock {\em\protect\JournalTitle{Phys. Rev. Lett.}} \textbf{48}, 1204--1207 (1982).
	
	\bibitem{roche2008}
	PE Roche, CF Barenghi, Vortex spectrum in superfluid turbulence: {{Interpretation}} of a recent experiment.
	\newblock {\em\protect\JournalTitle{EPL}} \textbf{81}, 36002 (2008).
	
	\bibitem{roche2007}
	PE Roche, et~al., Vortex density spectrum of quantum turbulence.
	\newblock {\em\protect\JournalTitle{EPL}} \textbf{77}, 66002 (2007).
	
	\bibitem{Babuin2014}
	S Babuin, E Varga, L Skrbek, E L\'ev\^eque, PE Roche, Effective viscosity in quantum turbulence: a steady state approach.
	\newblock {\em\protect\JournalTitle{Europhys. Lett.}} \textbf{106}, 24006 (2014).
	
	\bibitem{bradley2006}
	DI Bradley, et~al., Decay of pure quantum turbulence in superfluid $^3${{H}}e-{{B}}.
	\newblock {\em\protect\JournalTitle{Phys. Rev. Lett.}} \textbf{96}, 035301 (2006).
	
	\bibitem{barenghi1989modulated}
	C Barenghi, C Jones, Modulated taylor--couette flow.
	\newblock {\em\protect\JournalTitle{Journal of Fluid Mechanics}} \textbf{208}, 127--160 (1989).
	
	\bibitem{peixinho2007finite}
	J Peixinho, T Mullin, Finite-amplitude thresholds for transition in pipe flow.
	\newblock {\em\protect\JournalTitle{Journal of Fluid Mechanics}} \textbf{582}, 169--178 (2007).
	
	\bibitem{xu2008density}
	...
	\newblock {\em\protect\JournalTitle{AIP Conf. Proc.}} \textbf{985}, 191--198 (2008).
	
	\bibitem{tang2023visualization}
	Y Tang, et~al., Imaging quantized vortex rings in superfluid helium to evaluate quantum dissipation.
	\newblock {\em\protect\JournalTitle{Nat. Commun.}} \textbf{14}, 2941 (2023).
	
	\bibitem{tang2021visualization}
	Y Tang, S Bao, W Guo, Superdiffusion of quantized vortices uncovering scaling laws in quantum turbulence.
	\newblock {\em\protect\JournalTitle{Proc. Natl. Acad. Sci. U.S.A.}} \textbf{118}, e2021957118 (2021).
	
	\bibitem{fonda2016injection}
	E Fonda, KR Sreenivasan, DP Lathrop, {Sub-micron solid air tracers for quantum vortices and liquid helium flows}.
	\newblock {\em\protect\JournalTitle{Rev. Sci. Instrum.}} \textbf{87}, 025106 (2016).
	
	\bibitem{GiuriatoQuantumVortexReconnections2020}
	U Giuriato, G Krstulovic, Quantum vortex reconnections mediated by trapped particles.
	\newblock {\em\protect\JournalTitle{Phys. Rev. B}} \textbf{102}, 094508 (2020).
	
	\bibitem{schwarz1988}
	{\relax KW} Schwarz, Three-dimensional vortex dynamics in superfluid {$^{4}$}{{He}}.
	\newblock {\em\protect\JournalTitle{Phys. Rev. B}} \textbf{38}, 2398 (1988).
	
	\bibitem{galantucciNewSelfconsistentApproach2020b}
	...
	\newblock {\em\protect\JournalTitle{Eur. Phys. J. Plus}} \textbf{135}, 547 (2020).
	
	\bibitem{kivotides-barenghi-samuels-2000}
	D Kivotides, CF Barenghi, DC Samuels, Triple vortex ring structure in superfluid helium ii.
	\newblock {\em\protect\JournalTitle{Science}} \textbf{290}, 777 (2000).
