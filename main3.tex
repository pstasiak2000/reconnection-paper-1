...
(dimensionless) times, \blue{here in units of $\tau=0.183$s}.
...
In all cases, normal fluid structures generated by moving superfluid vortex rings \cite{kivotides-barenghi-samuels-2000}, are initially prepared to eliminate \magenta{any potential transients} (see SM for details).
...
results. The scaling law (Eq.~\ref{eq:scaling}) and the \blue{range of values of $A^-$} hence appear to have a universal character in vortex reconnections, independently of the nature
of the fluid, classical or quantum. \magenta{\cancel{and temperature.}}
...
\paragraph*{Conclusions.---} We have conducted an experiment using \magenta{passive} particle tracers and a \magenta{suite of numerical simulations of} vortex reconnections \magenta{over} a wide range of temperatures using a model of $^4$He which accounts for the coupled dynamics of superfluid and normal fluid components.
